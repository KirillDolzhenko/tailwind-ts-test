...
export default function () {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-y-5 ssmAndMd:gap-x-3 ssmAndMd:gap-y-10 ssmAndMd:grid-cols-2 md:gap-x-7 lg:gap-y-20 md:grid-cols-3 lg:grid-cols-4">
        {nfts.map((el) => (
      ...
      <GradientButton
        ...
        className="mx-auto self-center mt-10"
